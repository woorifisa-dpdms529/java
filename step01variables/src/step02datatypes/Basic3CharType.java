...
public class Basic3CharType {

	public static void main(String[] args) {
		// 4. 문자 타입 char

		// 4-1. 문자 타입, 문자를 담을 때 사용, 한 글자의 문자만 저장할 수 있음
		char a = 'A'; // 문자 타입에만 홑따옴표 사용 가능

		// 4-2. 문자 리터럴과 문자열 리터럴
		/*
		 * char : Character, 문자의 줄임표현, 홑 따옴표('')사용, 하나의 문자만 감쌀 때 사용하는 Java 키워드 String :
		 * String, 끈을 의미, 하나의 문자가 연속적으로 나열되어있다는 의미, 쌍 따옴표("") 사용, 두 개 이상의 문자를 사용할 때 쓰는
		 * Java 키워드
		 */
